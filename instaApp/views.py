...
def user_profile(request, id):
    ...
    context = {"current_user": current_user, "photos": photos}
...
def edit_profile(request, id):
    ...
    context = {"current_user": current_user, "profile_form": profile_form, "user_form": user_form}
...
def upload_photo(request):
    ...
    return render(request, 'dashboard/create_post.html', {"uploads_form": uploads_form})
